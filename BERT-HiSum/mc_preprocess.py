...
if __name__ == '__main__':
    ...
    # parser.add_argument("-map_path", default='../../both/')
    parser.add_argument("-raw_path", default='../../both/CNN-DM/line_data')
    parser.add_argument("-save_path", default='../../both/CNN-DM/bert_data')
    ...
    parser.add_argument('-log_file', default='../logs/dataPreprocess.log')
    ...
    args.raw_path = 'mc_data/line'
    args.save_path = 'mc_data/bert/'
    ...
    data_builder.DS_format_to_bert(pretrained_path, 'both', 'user', args)
