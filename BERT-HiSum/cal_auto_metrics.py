...
if __name__ == '__main__':
    ...
    #final_files = ['PGN', 'fast_rl_single', 'fast_rl_cont', 'human']
    #calculate(final_dir, final_files)
    #pred_txt = 'logs/bert_ext_final.txt_step2400.candidate'
    #gold_txt = 'logs/bert_ext_final.txt_step2400.gold'
    pred_txt = 'logs/bert_star_final.txt.3600.candidate'
    #gold_txt = '../../results/final/gold_refs.txt'
    gold_txt = 'logs/bert_star_final.txt.3600.gold'
    #pred_txt = '../../results/final/bert_abs_true_preds.txt'
    #gold_txt = '../../results/final/gold_refs.txt'
