...
def build_trainer(args, device_id, model, optims,loss, tokenizer):
    ...
    Args:
        ...
        data_type (str): string describing the type of both
            e.g. "text", "img", "audio"
...
class Trainer(object):
    ...
    def train(self, train_iter_fct, train_steps, valid_iter_fct=None, valid_steps=-1):
        ...
        by iterating over training both (i.e. `train_iter_fct`)
        ...
        Args:
            ...
            valid_iter_fct(function): same as train_iter_fct, for valid both
            train_steps(int):
            valid_steps(int):
    ...
    def validate(self, valid_iter, step=0):
        """ Validate model.
            valid_iter: validate both iterator
        Returns:
        ...
        with torch.no_grad():
            for batch in valid_iter:
                ...
                tf_isf = batch.tf_isf
                outputs, _ = self.model(src, tgt, segs, clss, mask_src, mask_tgt, mask_cls, sentence_mask, tf_isf)
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            outputs, scores = self.model(src, tgt,segs, clss, mask_src, mask_tgt, mask_cls, sentence_mask, tf_isf)
