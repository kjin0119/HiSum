...
def get_input_from_batch(features, device, vocab):
    ...
    enc_input_ids, enc_lens, enc_batch_extend_vocab, art_oovs, max_art_oovs, sentence_mask, tf_isf = features[0]
    ...
    return enc_input_ids, enc_padding_mask, enc_lens, enc_batch_extend_vocab, extra_zeros, c_t_1, coverage, sentence_mask, tf_isf
