...
def get_rouge(preds, refs, lang="zh", rouge_types=None, use_stemmer=False):
...
cands = load_lines("../tmp/csds_star/generated_predictions.txt")
refs = load_lines("../results/csds_final.refs")
